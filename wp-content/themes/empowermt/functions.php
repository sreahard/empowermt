...
add_action( 'after_setup_theme', 'empowermt_setup' );


/**
 *  WP Enqueue Style
 */
function empowermt_wp_enqueue_style() {
    wp_enqueue_style( 'empowermt_style', get_stylesheet_uri(), array(), '1.0' );
    ...
    wp_enqueue_script( 'empowermt_scripts', get_template_directory_uri() . '/js/scripts.js', array( 'jquery','jquery-masonry','carouFredSel' ), '1.0', true );
...
add_action( 'wp_enqueue_scripts', 'empowermt_wp_enqueue_style' );

function empowermt_navigation_menu() {
...
add_action( 'init', 'empowermt_navigation_menu' );

function empowermt_sidebar() {
...
add_action( 'widgets_init', 'empowermt_sidebar' );

require_once dirname( __FILE__ ) . '/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'empowermt_required_plugins' );

function empowermt_required_plugins() {
...
function empowermt_wp_title( $title, $sep ) {
	global $paged, $page;
...
add_filter( 'wp_title', 'empowermt_wp_title', 10, 2 ); 

function empowermt_add_editor_styles() {
    add_editor_style( '/css/custom-editor-style.css' );
}
add_action( 'init', 'empowermt_add_editor_styles' );

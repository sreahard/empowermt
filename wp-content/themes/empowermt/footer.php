...
<footer>
	...
	<div class="footer-two cf">
		<div class="wrap">
			<p>
				<?php _e('Copyright','cw-business-lite'); ?> &copy; <a href="#" title="Movatique" target="_blank" rel="nofollow">Empower MT</a> <?php _e('is proudly powered by','cw-business-lite'); ?> <a href="http://wordpress.org/" title="WordPress" target="_blank" rel="nofollow">WordPress</a>. <?php _e('All rights reserved.','cw-business-lite'); ?>
			</p>
		</div><!--/.wrap-->
	</div><!--/.footer-two-->
</footer><!--/footer-->
